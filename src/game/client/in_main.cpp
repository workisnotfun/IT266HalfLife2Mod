...
static  kbutton_t   in_force;	//gg65 adding force button
...
int CInput::GetButtonBits( int bResetState )
{
	...
	CalcButtonBits( bits, IN_FORCE, s_ClearInputState, &in_force, bResetState ); //gg65 for adding the button for force
...
static ConCommand startforce("+force", IN_ForceDown); //gg65 for adding the button for force
